  ...
  return (
    <div  id="header" >
      <ul className="right">
        ...
        <li><NavLink to='/notifications' id="notification-link" className="btn btn-floating teal lighten-1">{props.profile.initials}</NavLink></li>
      </ul>      
      {(() => {
        if (count > 0) {
      ...
      {(() => {
        if (Open) {
          ...
          return <div id="dropdown">
            <button id="bars" className="link" onClick={handleClick}><FontAwesomeIcon style={{color: "turqoiuse"}} icon={faBars} />
