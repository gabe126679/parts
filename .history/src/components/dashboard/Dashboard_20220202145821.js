    ...
    return (
      <div className="dashboard container">
        <div className="search-box">
          <form className="searchForm" style={searchForm} onSubmit={handleSubmit}>
            <input className="searchBar" style={searchBar} onChange={handleChange} type="search" id="search" name="search" placeholder="Search Tags"/>
          </form>
        </div>
        <div className="row">
