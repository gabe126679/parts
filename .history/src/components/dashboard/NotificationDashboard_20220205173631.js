        ...
        notifications.map(async (item) => {
            ...
            data.docs.forEach(doc => {
                if (doc.user === e.target.value) {
                    doc._delegate._document.data.value.mapValue.fields.viewedBy.arrayValue.values.push(e.target.value);                    
                }
                console.log(doc._delegate._document.data.value.mapValue);
                console.log(auth)
