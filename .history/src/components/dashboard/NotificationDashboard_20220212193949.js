...
const NotificationDashboard = (props) => {
    ...
    const handleClick = (e) => {
        ...
        notifications.map(async (item) => {
            ...
            data.docs.forEach(async doc => {
                if ((doc.id === auth.uid && !doc.data().viewedUpdates.includes(item.id) && item.id === e.target.value) || (doc.id === auth.uid && !doc.data().viewedUpdates.includes(item.id) && item.id === e.target.value)) {
    ...
    const handleNoise = () => {
        ...
        //         //     console.log(doc.id);
        //         // }
        //         console.log(!doc.data.viewedUpdates.includes(item.id))
