        ...
        <div className="row">
          ...
          {(() => {
            ...
            if (this.state.category === "fuel and air") {
                ...
                return <a><button onClick={handleClick2}>fuel and air</button></a>      
            }
          })()}
                    {(() => {
            if (this.state.category === "lights and electrical") {
                ...
                return <a><button onClick={handleClick2}>lights and electrical</button></a>      
            }
          })()}
                    {(() => {
            if (this.state.category === "brakes") {
                ...
                return <a><button onClick={handleClick2}>brakes</button></a>      
            }
          })()}
                    {(() => {
            if (this.state.category === "body") {
                ...
                return <a><button onClick={handleClick2}>body</button></a>      
            }
          })()}
          {(() => {
            if (this.state.category === "tires and wheels") {
                ...
                return <a><button onClick={handleClick2}>tires and wheels</button></a>      
            }
          })()}
          {(() => {
            if (this.state.category === "custom") {
                ...
                return <a><button onClick={handleClick2}>custom</button></a>      
            }
          })()}
          {/* {(() => {
            if (this.state.category === "fuel and air") {
