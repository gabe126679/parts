  ...
  render() {
    ...
    const handleClick = (e) => {
      ...
      this.props.projects.map((tag) => {
        if ([e.target.id] === tag.category) {
          tag.category = newString;
        } 
        this.setState({ category: newString });
    ...
    return (
      <div className="dashboard container">
        ...
        <div className="row">
          ...
          {(() => {
            tags.map((tag) => {
              if (tag.category === this.state.category) {
                return <a><button onClick={handleClick}>All Products</button></a>               
              } else {
                return <a><button onClick={handleClick}>taga</button></a>      
            }
            })
          ...
          {/* {(() => {
            ...
            <a  href="#about"><button id="exhaust" onClick={handleClick}>lights and electrical</button></a>
            <a href="#contact">engine parts and accessories</a>
            <a  href="#about"><button id="lights and electrical" onClick={handleClick}>lights and electrical</button></a>
