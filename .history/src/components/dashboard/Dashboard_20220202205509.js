          ...
          {(() => {
              if (
                ...
                return (
                  <div className="col s12 m6">
                    { projects && projects.map(project => {
                        if (project.title === this.state.search || project.content === this.state.search || project.authorFirstName === this.state.search || project.authorLastName === this.state.search) {
                          return (
                            <Link to={'/project/' + project.id}>
                              <ProjectSummary project={project} key={project.id} />
                            </Link>
