...
const ProjectDetails = (props) => {
    ...
    async function handleToken(token) {
      ...
      const response = await fetch("https://firestore.googleapis.com/google.firestore.v1.Firestore/Listen/channel?database=projects%2Fmotorcycle-parts-e29b5%2Fdatabases%2F(default)&gsessionid=mKHSTlJDp3DiasVBpWsQm9lchYueunLKbbTHP5OlbrE&VER=8&RID=rpc&SID=lWWxqLJGwK859CREM4XDiA&CI=0&AID=118&TYPE=xmlhttp&zx=k1ondz8uzdz6&t=1/projectCheckout", {
        method: 'POST',
        token,
        product
      });
