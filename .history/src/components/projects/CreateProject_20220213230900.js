    ...
    return (
      <div className="container">
        <form onSubmit={this.handleSubmit} className="white">
          ...
          <div className="input-field">
              <input type="text" id="partNumber" value={this.state.partNumber} onChange={this.handleChange} />
          </div>
          ...
          <div className="input-field">
            <div >
              <UploadForm />
                <ImageGrid selectedImg={this.selectedImg} setSelectedImg={this.handleImg.bind(this)}/>
                {/* { this.state.selectedImg && (
                  <Modal selectedImg={this.state.selectedImg.bind(this)} setSelectedImg={this.handleImg.bind(this)} />
                )} */}
                { this.state.selectedImg }
            </div>
          </div>
