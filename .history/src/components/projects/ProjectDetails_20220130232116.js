        ...
        <div className="container section project-details">
          <div className="card z-depth-0">
            <div className="card-content">
              ...
              <p>{project.content}</p>
                  <Link to={'/projectPurchase/' + props.match.params.id} className="btn purple lighten-1" style={button2Style}>
                    purchase       
                  </Link>
                  <h3 style={headerStyle}>{project.price}</h3>
            </div>
            <div className="card-image card small">
              <img className="card small" src={project.photos[0]}/>
