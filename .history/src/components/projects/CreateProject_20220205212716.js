...
class CreateProject extends Component {
  ...
  handleChange = async (e) => {
    if ((e.target.id === "price" && this.state.price === "") || (e.target.id === "price" && this.state.price === "")) {
      this.setState({
    ...
    return (
      <div className="container">
        <form onSubmit={this.handleSubmit} className="white">
          ...
          <div className="input-field">
              <input type="number" min="0.00" max="10000.00" placeholder="$" step="1" id="price" value={this.state.price} onChange={this.handleChange} />
          </div>
          <label htmlFor="price">Shipping Cost</label>
          <div className="input-field">
              <input type="number" min="0.00" max="10000.00" placeholder="$" step="1" id="shippingCost" onChange={this.handleChange} />
          </div>
