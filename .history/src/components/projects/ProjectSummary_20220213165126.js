...
import { faUp } from '@fortawesome/free-solid-svg-icons';
      ...
      <div className="card z-depth-0 project-sumarry">
        <div className="card-content grey-text text-darken-3">
          ...
          <p className="grey-text">{moment(project.createdAt.toDate()).calendar()}</p>
            ...
            <p className="right-align">{project.upvoteCount} <button onClick={handleClick}><FontAwesomeIcon style={{color: "red"}} icon={faUp} /></button> </p>
