...
const ProjectDetails = (props) => {
    ...
    const handleSubmit = (e) => {
      e.preventDefault(); 
      props.updateProject(display, props.match.params.id, auth.uid)
      console.log(e);
    }
    const handleChange = (e) => {
      e.preventDefault();
      project.comments.map((post) => {
        // if (post === project.authorId) {
        //   return <div className="yellow center">{project.comments.comment}</div>
        ...
        <div className="container section project-details">
          <div className="card z-depth-0">
            ...
            <div className="card-action grey lighten-4 grey-text">
              ...
              {(() => {
                project.comments.map((post) => {
                  return <div><div className="yellow center">{post.comment}
                  </div>
                  <div className="blue center">{post.author}</div>
                  </div>
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    updateProject: (comment, project, author) => dispatch(updateProject(comment, project, author))
    }
}
