      ...
      <div className="container">
        <form onSubmit={this.handleSubmit} className="white">
          ...
          <div className="input-field">
            <div >
              <UploadForm />
                <ImageGrid  setSelectedImg={() => this.setState({ selectedImg: this.state.selectedImg })}/>
                { this.state.selectedImg && (
                  <Modal selectedImg={this.state.selectedImg} setSelectedImg={() => this.setState({ selectedImg: this.state.selectedImg })} />
                )}
                { this.state.selectedImg }
            </div>
          </div>
