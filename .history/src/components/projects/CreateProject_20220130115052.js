        ...
        <form onSubmit={this.handleSubmit} className="white">
          ...
          <div className="input-field">
            <div>
              {/* <Display /> */}
              <UploadForm />
                <ImageGrid setSelectedImg={() => {this.setState()}} />
                { this.state.selectedImg && this.state.photos.push(this.state.selectedImg)}
            </div>
          </div>
          <div className="input-field">
            <button onClick={this.check} className="btn pink lighten-1 ">
            Check
            </button>
