    ...
    return (
      <div className="container">
        ...
        <form onSubmit={this.handleSubmit} className="white">
          ...
          <div className="input-field">
              <input type="number" min="0.00" max="10000.00" placeholder="$" step="0.01" id="price" onChange={this.handleChange} />
          </div>
          <label htmlFor="price">Shipping Cost</label>
          <div className="input-field">
              <input type="number" min="0.00" max="10000.00" placeholder="$" step="0.01" id="shippingCost" onChange={this.handleChange} />
          </div>
